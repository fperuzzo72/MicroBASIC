...
def cap_stem_width(bits):
    ...
    upscale, not a deliberately-wide horizontal bar like -, _ or =.

    Sem a checagem vertical, um glifo que e essencialmente uma barra larga
    (a propria barra longa dele E a mediana) era lido como haste engordada e
    cortado para MAX_STEM_WIDTH. O hifen nativo ocupa 6 dos 8 px da celula
    (75%); depois do redimensionamento saia com 3px em vez dos ~11 que a
    proporcao pedia, virando quase um ponto."""
